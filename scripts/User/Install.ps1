...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      ...
      <Arguments>-file %programdata%\HyperGame\VDDMonitor.ps1</Arguments>
    </Exec>
  </Actions>
</Task>
"@
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      <Command>C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe</Command>
      <Arguments>-file %programdata%\HyperGame\VBCableInstall.ps1</Arguments>
    </Exec>
  </Actions>
</Task>
"@
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      <Command>C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe</Command>
      <Arguments>-file %programdata%\HyperGame\ParsecVDDInstall.ps1</Arguments>
    </Exec>
  </Actions>
</Task>
"@
